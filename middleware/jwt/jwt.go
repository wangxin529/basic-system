...
type GinJWTMiddleware struct {
	...
	Authenticator func(c *gin.Context, ctx *svc.ServiceContext) (interface{}, error)
	...
	// Set the identity router function
...
func (mw *GinJWTMiddleware) LoginHandler(c *gin.Context) {
	...
	data, err := mw.Authenticator(c, mw.SvCtx)
	if err != nil {
